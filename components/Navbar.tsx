...
import { useState, useEffect } from "react"
import { Link as ScrollLink } from "react-scroll" // Correct for scrolling
import NextLink from "next/link" // Correct for page navigation
import { motion } from "framer-motion"
import { useTheme } from "next-themes"
import { SunIcon, MoonIcon } from "@heroicons/react/24/outline"
...
const navItems = [
  ...
  { name: "Blog", href: "/blog", type: "route" }, // ✅ Blog page
  { name: "Create Post", href: "/create-post", type: "route" }, // ✅ Create post page
